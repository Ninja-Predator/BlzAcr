...
public class GunbreakerRotationEntry : IRotationEntry
{
    ...
    public bool BuildQt(out JobViewWindow jobViewWindow)
    {
        ...
        jobViewWindow.AddHotkey("刚玉tt", new HotkeyResolver_General(@"../../RotationPlugin/Blz/Resources/刚玉tt.png", () =>AI.Instance.BattleData.HighPrioritySlots_OffGCD.Enqueue(SpellHelper.GetSpell(SpellsDefine.HeartOfCorundum, SpellTargetType.TargetTarget))));
